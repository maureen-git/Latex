...
$q_3*C_{\ce{CH3OH},3} - q_3*C_{\ce{CH3OH},4} = k_1 * V$\\
$q_3*(C_{\ce{CH3OH},3} - C_{\ce{CH3OH},4} )= k_1 * V$\\
$q_3*(C_{\ce{CO},3} - C_{\ce{CO},4} )= k_1 * V$\\
$q_3*(C_{\ce{CO},3} - C_{\ce{CO},3} * (1-x_{\ce{CO}}))= k_1 * V$\\
$V = 81 m^3$\\
\\ \\
...
\\
$q_3*C_{\ce{CH3COOH},4}-F_{\ce{CH3COOH}, 6}=0$\\
$q_3*(C_{\ce{CO},3}-C_{\ce{CO},4})-F_{\ce{CH3COOH}, 6}=0$\\
$q_3*(C_{\ce{CO},3}-C_{\ce{CO},3}*(1-x_{\ce{CO}}))-F_{\ce{CH3COOH}, 6}=0$\\
$F_{\ce{CH3COOH}, 6}=8.1 \ mol/h$\\
\\ \\
$F_{\ce{CH3COOH}, 6}=x_{\ce{CH3COOH},6}*F_{tot,6}$\\
$F_{tot,6}= \frac{F_{\ce{CH3COOH}, 6}}{x_{\ce{CH3COOH},6}}$\\
$F_{tot,6}= 10.125\ mol/h$\\
\\
$F_{\ce{CH3OH}, 6}=x_{\ce{CH3OH},6}*F_{tot,6}$\\
$F_{\ce{CH3OH},6}= 2.025\ mol/h$\\
\\ \\ 
\noindent Massabalans $\ce{CH3OH}$ over de distillatiekolom:\\
\\
$q_3*C_{\ce{CH3OH},4}-F_{\ce{CH3OH}, 5} - F_{\ce{CH3OH},6}=0$\\
$q_3*(C_{\ce{CH3OH},3}-(C_{\ce{CO},3}-C_{\ce{CO},4}))-F_{\ce{CH3OH}, 5} - F_{\ce{CH3OH}, 6}=0$\\
$F_{\ce{CH3OH}, 5}=q_3*(C_{\ce{CH3OH},3}-(C_{\ce{CO},3}-C_{\ce{CO},4})) - F_{\ce{CH3OH}, 6}$\\
$F_{\ce{CH3OH}, 5}= 3.375 \ mol/h$\\
\\ \\
\noindent Massabalans $\ce{CO}$ over de distillatiekolom:\\
$q_3*C_{\ce{CO},4}-F_{\ce{CO}, 5}=0$\\
$q_3*C_{\ce{CO},3}*(1-x_{\ce{CO}})-F_{\ce{CO}, 5}=0$\\
$F_{\ce{CO}, 5}=0.9 \ mol/h$\\
...
\\ \\
\noindent Nee, omwille van zero-order kinetiek. Een hoger molair debiet van de reagentia zal niet leiden tot een verhoging van de reactiensnelheid. Enkel een groter volume van de CSTR zou leiden tot een hogere productie van azijnzuur.
\\ \\
\noindent We kunnen dit ook aantonen aan de hand van de massabalans:\\
\\ 
\noindent Massabalans \ce{CH3OH} over CSTR:\\
$F_{\ce{CH3OH},3} + F_{\ce{CH3OH},5}- F_{\ce{CH3OH},4} + R_{\ce{CH3OH}}(C_{\ce{CH3OH},4})*V=0$\\
$F_{\ce{CH3OH},4} = 9.9 mol/h$ \\
\\ 
$- \Delta F_{\ce{CH3OH}} = \Delta F_{\ce{CH3COOH}} = -(F_{\ce{CH3OH},4} - (F_{\ce{CH3OH},3} + F_{\ce{CH3OH},5}))$\\
$\Delta F_{\ce{CH3COOH}}= 8.1 \ mol/h$\\
\\ \\
...
\\
$\epsilon= \frac{(2.025+8.1+8.1+5.95+1.9)-(2.025+8.1+10+10)}{(2.025+8.1+10+10)}=-0.134$\\
\\ \\

\noindent Initiële concentratie:\\
\\
$C_{\ce{CH3COOH},8}=\frac{y_{\ce{CH3COOH},8}*P_8}{R*T_8}=\frac{0.269*1 \ atm}{0.08205 \frac{m^3*atm}{K*kmol}*400K}=8.2 \frac{mol}{m^3}$\\
\\ \\ 

\noindent Volume uitwerken:\\
\\
$V=\frac{8.1\frac{mol}{h}}{0.1\frac{1}{h}*8.2\frac{mol}{m^3}}((1-0.134)*ln(\frac{1}{1-0.9})+0.134*0.9)=20.89\ m^3$\\
\\ \\
